...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2022 at 08:47 AM
...
(NULL, 'Comment jumeler sa montre avec son compte ?', 'Il est très simple de synchroniser la montre à votre compte, un code vous sera fourni lors de l\'acquisition de la montre. Il suffira d\'aller votre compte et mettre ce code pour jumeler les deux ensemble.'),
(NULL, 'Le délai de préparation et d’envoi des commandes ?', 'Dès la commande valider, la montre partira en fabrication. Compter une à deux semaines pour la réception de votre commande.');
